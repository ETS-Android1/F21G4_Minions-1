            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
               if(snapshot.exists()){
                   ...
                   if(shippingState.equals("shipped")){
                        txtTotalAmount.setText("Dear: "+userName+" order is shipped!"+"\nTotal Amount = $"+overTotalPrice);
                        recyclerView.setVisibility(View.GONE);
                        txtMsg1.setVisibility(View.VISIBLE);
                        txtMsg1.setText("Your order is shipped. You will receive your order soon");
                       ...
                       txtTotalAmount.setText("Dear: "+userName+" your order is not shipped!");
                       recyclerView.setVisibility(View.GONE);
                       txtMsg1.setVisibility(View.VISIBLE);
                       txtMsg1.setText("Your order will be shipped soon");
                       nextProcessBtn.setVisibility(View.GONE);
                       Toast.makeText(CartActivity.this, "You can purchase more products, once you receive your first final order!", Toast.LENGTH_LONG).show();
